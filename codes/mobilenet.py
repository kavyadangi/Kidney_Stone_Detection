...
model_path = '/home/asus/Desktop/Image Processing/Project/Kidney_stone_detection/models/mobilenet.h5'
metrics_csv_path = '/home/asus/Desktop/Image Processing/Project/Kidney_stone_detection/evaluation_metrics/mobilenet.csv'
...
def mobilenet_model(input_shape=(224, 224, 3), num_classes=2):
...
mobilenet = mobilenet_model(input_shape=(224, 224, 3), num_classes=len(np.unique(labels)))
mobilenet.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])

# Train the model
history = mobilenet.fit(X_train, y_train, epochs=10, batch_size=32, validation_data=(X_val, y_val))
...
y_pred = mobilenet.predict(X_val)
