...
model_path = '/home/asus/Desktop/Image Processing/Project/Kidney_stone_detection/models/vgg19.h5'
metrics_csv_path = '/home/asus/Desktop/Image Processing/Project/Kidney_stone_detection/evaluation_metrics/vgg19.csv'
...
def vgg19_model(input_shape=(224, 224, 3), num_classes=2):
...
vgg19 = vgg19_model(input_shape=(224, 224, 3), num_classes=len(np.unique(labels)))
vgg19.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])

# Train the model
history = vgg19.fit(X_train, y_train, epochs=10, batch_size=32, validation_data=(X_val, y_val))

# Save the model
os.makedirs(os.path.dirname(model_path), exist_ok=True)
vgg19.save(model_path)
print(f"VGG19 model saved to '{model_path}'.")

# Make predictions and evaluate
y_pred = vgg19.predict(X_val)
